...
public class BluetoothCameraFragment extends Fragment {
    //member fields
    public static BluetoothCameraFragment bluetoothCameraFragment;
    ...
    ////////////////////////////////////////생성자/////////////////////////////////////////
    public BluetoothCameraFragment() {
    }

    public static BluetoothCameraFragment newInstance() {
        Log.d(TAG, "newInstance");
        bluetoothCameraFragment = new BluetoothCameraFragment();
        return bluetoothCameraFragment;
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        Log.d(TAG, "onCreate camera fragment");
    ...
    @Override
    public void onStart() {
        Log.d(TAG, "onStart camera fragment");
        super.onStart();
    ...
    private void setUpConnection() {
        Log.d(TAG, "setUpConnection() server camera");
    ...
    //필요 기능 : 셔터 카메라가 저장 누르면 이 카메라의 화면을 찍고 저장한다!
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback = new CameraCaptureSession.CaptureCallback() {
        private void process(CaptureResult result) {
            if(mState!=STATE_PREVIEW) Log.d(TAG, "capturecallback의 process, 상태:"+mState);
            switch (mState) {
                case STATE_PREVIEW: {
                    break;
                }
