...
public class BluetoothShutterFragment extends Fragment {
    ...
    ////////////////////////////////////////생성자/////////////////////////////////////////
    public BluetoothShutterFragment() {
    }

    public static BluetoothShutterFragment newInstance() {
        Log.d(TAG, "newInstance");
        bluetoothShutterFragment = new BluetoothShutterFragment();
        return bluetoothShutterFragment;
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mBluetoothAdapter == null) {
            ...
            Toast.makeText(activity, "블루투스 지원 안 함", Toast.LENGTH_LONG).show();
            activity.finish();
        }
    }
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_bluetooth_shutter, container, false);
    }
    ...
    private void setStatus(CharSequence subTitle) {
        Log.d(TAG, "setStatus:" + subTitle.toString());
        FragmentActivity activity = getActivity();
        if (null == activity) {
            return;
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.MESSAGE_WRITE:
                    Log.d(TAG, "message write handler called");
                    byte[] writeBuf = (byte[]) msg.obj;
                    String writeMessage = new String(writeBuf);
                    break;
                case Constants.MESSAGE_READ:
                    Log.d(TAG, "message read handler called");
                    byte[] readBuf = (byte[]) msg.obj;
                    String readMessage = new String(readBuf, 0, msg.arg1);
                    if (readMessage.equals("TAKE_PICTURE")) {
                        showToast("Taking picture");
                        //takePicture();
                    } else if (readMessage.equals("PHOTO_SAVED")) {
                        showToast("Photo is saved in the gallery of the controlled device");
                    }
                    break;
                case Constants.MESSAGE_DEVICE_NAME:
                    Log.d(TAG, "connected device name handler called");
    ...
    private void connectDevice() {
        ...
        BluetoothDevice device = ShutterActivity.EXTRA_DEVICE;
...
//                Log.d(TAG,"secure bluetooth scanning");
//                Intent serverIntent = new Intent(getActivity(), DeviceListActivity.class);
//                startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE_SECURE);
//                return true;
//            }
//            case R.id.insecure_connect_scan: {
//                Log.d(TAG,"insecure bluetooth scanning");
//                Intent serverIntent = new Intent(getActivity(), DeviceListActivity.class);
//                startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE_INSECURE);
//                return true;
//            }
//            case R.id.discoverable: {
//                Log.d(TAG,"asking to be made discoverable");
//                ensureDiscoverable();
//                return true;
//            }
//        }
...
//    }
    ...
    /**Camera logic listeners and callbacks*/
//
...
//                        break;
//                    default:
//                        android.util.Log.e(TAG, "Display rotation is invalid: " + displayRotation);
//                }
//
...
//        Log.d(TAG,"captureStiillPicture");
//        try {
//            final Activity activity = getActivity();
...
//                                               @NonNull CaptureRequest request,
//                                               @NonNull TotalCaptureResult result) {
//                    showToast("Photo has been saved in gallery");
//                    //sendMessage("PHOTO_SAVED".getBytes());
//                    android.util.Log.d(TAG, mFile.toString());
//                    unlockFocus();
//                }
//            };
//
...
//            Log.d(TAG,"CompareSizesByArea:compare function");
...
//                    bluetoothShutterFragment.getActivity().getContentResolver(),
//                    b, "remote_Cam_" + time, "");
//        }
//    }
    ////////////////////////////////////////////카메라//////////////////////////////////////////
